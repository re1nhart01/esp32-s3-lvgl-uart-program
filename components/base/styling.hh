...
public:
  ...
  Styling* setPadding(lv_coord_t top, lv_coord_t bottom, lv_coord_t left, lv_coord_t right);
  Styling* setSize(lv_coord_t width, lv_coord_t height);
  Styling* setMinMaxSize(lv_coord_t min_w, lv_coord_t min_h, lv_coord_t max_w, lv_coord_t max_h);

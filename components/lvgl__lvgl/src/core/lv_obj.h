...
/**
 * The possible parts of components.
 * The parts can be considered as the internal building block of the components.
...
enum {
    ...
    LV_PART_CUSTOM_FIRST = 0x080000,    /**< Extension point for custom components*/

...
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_24 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
#if LV_FONT_MONTSERRAT_16
        font_normal    = &lv_font_montserrat_16;
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_16 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
    }
...
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_20 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
#if LV_FONT_MONTSERRAT_14
        font_normal    = &lv_font_montserrat_14;
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_14 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
    }
...
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_18 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
#if LV_FONT_MONTSERRAT_12
        font_normal    = &lv_font_montserrat_12;
#else
        LV_LOG_WARN("LV_FONT_MONTSERRAT_12 is not enabled for the components demo. Using LV_FONT_DEFAULT instead.");
#endif
    }
